...
//             this->board = std::vector<std::vector<Piece>>(size,
//             std::vector<Piece>(size, nullptr)); this->last_random_swap =
//             std::vector<std::vector<size_t>>(2, std::vector<size_t>(2, 0));
//         }
...
//         {
//             std::vector<std::vector<size_t>> movable_piece_coords_list =
//             this->get_movable_piece_coords_list();
//             std::vector<std::vector<size_t>>
//             random_movable_piece_coords_list;
//             std::random_shuffle(movable_piece_coords_list.begin(),
//             movable_piece_coords_list.end());
...
//             = this->get_2_random_movable_piece_coords();
//             this->swap(random_movable_piece_coords_list[0],
//             random_movable_piece_coords_list[1]);
//         }

//         void reverse_last_random_swap() {
//             if (this->last_random_swap[0][0] == 0 &&
//             this->last_random_swap[0][1] == 0 && this->last_random_swap[1][0]
//             == 0 && this->last_random_swap[1][1] == 0) {
//                 return;
//             }
//             this->swap(this->last_random_swap[0], this->last_random_swap[1]);
//             this->last_random_swap = std::vector<std::vector<size_t>>(2,
...
//                     if (north_piece != nullptr && piece.getNorth() !=
//                     north_piece.getSouth()) {
//                         loss += 1;
//                     }
//                     if (south_piece != nullptr && piece.getSouth() !=
//                     south_piece.getNorth()) {
//                         loss += 1;
//                     }
//                     if (east_piece != nullptr && piece.getEast() !=
//                     east_piece.getWest()) {
//                         loss += 1;
//                     }
//                     if (west_piece != nullptr && piece.getWest() !=
//                     west_piece.getEast()) {
//                         loss += 1;
//                     }
//                 }
